...
use PhpOffice\PhpWord\Shared\Converter;
	...
	function afficheFormulaireWord(){
...
?>	
	...
	<link rel="stylesheet" href="css/word-style.css" />
		...
		<font size="5">
			<I>
				<B>
					...
					<label class="container">Compte Rendu Complet
  						<input type="radio" name="choix" id="generale" value="generale" onclick="test();">
  						<span class="checkmark"></span>
					</label>
					<label class="container">Compte Rendu Partiel
	...
	<p id='app2'></p> 
	<center>
		<a id='btnGenerer' href='index.php?page=crCOMPLET&id=<?php echo($idChantier)?>&idChantier=<?php echo($idChantier)?>&idChantierAdmin=<?php echo($idChantierAdmin)?>&dateDeb="COMPLET"&dateFin="COMPLET"'  
			class='btn btn-primary'>Créer le Compte Rendu
		</a>
		<a id='btnGenererP' href='index.php?page=crPARTIEL&id=<?php echo($idChantier)?>&idChantier=<?php echo($idChantier)?>&idChantierAdmin=<?php echo($idChantierAdmin)?>&dateDeb=<?php echo($dateDeb)?>&dateFin=<?php echo($dateFin)?>'  
			class='btn btn-primary'>Créer le Compte Rendu
		</a>
	</center>
	<script type="text/javascript">
